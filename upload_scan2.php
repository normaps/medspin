...
if($isLoggedIn != '1'){
    session_destroy();
    header('Location: login.php?url=upload_scan2.php');
}
?>
...
<div id="header">UPLOAD FOTO SCAN KTP ANGGOTA I</div>
...
echo "Cek foto anda, jika sudah benar klik <a href='upload4.php?nama=$url'><B>DISINI</B></a>";

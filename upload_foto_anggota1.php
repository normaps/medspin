...
if($isLoggedIn != '1'){
    session_destroy();
    header('Location: login.php?url=upload_foto_anggota1.php');
}
?>
...
<div id="header">UPLOAD FOTO ANGGOTA 1</div>
...
echo "Cek foto anda, jika sudah benar klik <a href='upload1.php?nama=$url'><B>DISINI</B></a>";

...
if($isLoggedIn != '1'){
    session_destroy();
    header('Location: login.php?url=upload.php');
}
...
//query for update data in database
 $query = "UPDATE reg SET photo = '$no' WHERE nim = '$username'" ;
...
<div style='text-align:center; margin-top:200; font-size:25;'><?php echo $wellcome;?></div><br/><a href='http://medspinfkunair.com/registration/upload_foto.php'><button class='btn-submit' style='border-radius:10px; width:50%; margin:20px auto;'>KEMBALI</button></a>

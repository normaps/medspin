...
if($isLoggedIn != '1'){
    session_destroy();
    header('Location: login.php?url=upload_foto_anggota2.php');
}
?>
...
<div id="header">UPLOAD FOTO Anggota II</div>
...
echo "Cek foto anda, jika sudah benar klik <a href='upload2.php?nama=$url'><B>DISINI</B></a>";

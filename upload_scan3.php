...
if($isLoggedIn != '1'){
    session_destroy();
    header('Location: login.php?url=upload_scan3.php');
}
?>
...
<div id="header">UPLOAD FOTO SCAN KTP ANGGOTA II</div>
...
echo "Cek foto anda, jika sudah benar klik <a href='upload5.php?nama=$url'><B>DISINI</B></a>";

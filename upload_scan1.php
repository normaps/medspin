...
if($isLoggedIn != '1'){
    session_destroy();
    header('Location: login.php?url=upload_scan1.php');
}
?>
...
<div id="header">UPLOAD FOTO SCAN KTP KETUA KELOMPOK</div>
...
<p> 1. Foto Scan KTP berwarna atau hitam putih</p>
...
echo "Cek foto anda, jika sudah benar klik <a href='upload3.php?nama=$url'><B>DISINI</B></a>";

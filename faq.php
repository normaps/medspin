...
if($isLoggedIn != '1'){
    session_destroy();
    header('Location: login.php?url=faq.php');
}
?>
<html>
<head>
...
<body style="background:url(http://medspinfkunair.com/pq/images/bg-w.png);"> 
				<div align="center" style=" font-weight:700; color:white;  background-color:#028fcc; opacity:0.9; padding:20px 50px; position:absolute; top:0; left:0; right:0;">&raquo; FAQ &laquo;</div><br/><br/><br/>
...
<div id="header">FAQ (Frequently Asked Auestions)</div>
...
<div class="row  wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
                  <div class="col-sm-12"> 
                    <div class="form-group"><B> Pertanyaan :</B> 
                      <input type="text" name="nim" value="" readonly="" class="form-control">
                    </div>
                  </div>
</div>
...
<div class="row  wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
                 ...
                 <a href="http://registration.medspinfkunair.com/panduan.php" > <button type="button" value="Send" class="btn-submit" style="border-radius:10px;"> KEMBALI</button>
                </div>
